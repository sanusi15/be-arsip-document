...
const cloudinaryCopy = async (sourcePublicId, targetPublicId) => {
    try {
        const upload = await cloudinary.uploader.upload(sourcePublicId, {
...
module.exports = {cloudinaryUpload, cloudinaryCopy}